...
final String topicName = "khalek18/feeds/temp";
...
//
  ...
  void _onDisconnected() {
    //xlog.info('OnDisconnected client callback - Client disconnection');
  ...
  Future<MqttClient> _login() async {
    ...
    //MqttServerClient client = MqttServerClient.withPort(connectJson['broker'], connectJson['key'],1880);
